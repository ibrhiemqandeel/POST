<x-muster title="POST" description="Premium Origin Stories & Thoughts">
    <main>
        ...
        <section class="section container">
            ...
            <div class="cat-grid">
                ...
                <a class="cat-card reveal" data-d="3" href="accessories.html">
                    ...
                    <span class="arrow">→</span>
                    <div><small>Finishing touches</small>
                        <h3>Accessories</h3>
                    </div>
                </a>
            </div>
        ...
        <!-- PROMISE STRIP -->
        <m class="section--tight" style="background:var(--cream-2);border-block:1px solid var(--line)">
            <div class="container">
