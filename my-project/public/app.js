  ...
  footer: {
    ...
    columns: [
      { title: "Shop", links: [
        ...
        { label: "Beauty",       href: "beauty.html" },
        { label: "Accessories",  href: "accessories.html" },
        { label: "New Arrivals", href: "women.html" }
      ]},
      { title: "House", links: [
        { label: "Our Story",  href: "about.html" },
        { label: "Journal",    href: "about.html" },
        { label: "Stockists",  href: "contact.html" },
      ...
      { title: "Care", links: [
        ...
        { label: "Size Guide",     href: "contact.html" },
        { label: "Gift Cards",     href: "contact.html" }
      ]}
    ]
  },
